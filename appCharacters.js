...
const aiEnable = 1;
const debugAI = 0;
const maxCharacterSpeed = 0.5; //change this in powerup
let ragemode=0;//To keep record of rage
...
class Character extends GameObject 
{
    ...
    update() 
    {
        ...
        if(!ragemode){
            ...
            this.velocity.x = clamp(this.velocity.x + moveInput.x * .094, maxCharacterSpeed, -maxCharacterSpeed);
        }//Made this changes so that speed inscrease in ragemode
        ...
        // randomly blink
        rand() < .01 && this.blinkTimer.set(rand(.2,.1));//Updated the blinking of eye Looks more cool i think
    }
...
class Player extends Character
{
    ...
    update()
    {
        ...
        this.holdingShoot  = !this.playerIndex && (keyIsDown(70) || keyIsDown(90))|| gamepadIsDown(2, this.playerIndex);
