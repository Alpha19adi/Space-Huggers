...
function applyArtToLevel() {
    ...
    if (precipitationEnable && !lowGraphicsSettings) {
      // create rain, snow, or lava particles
      const weatherType = rand();
      if (weatherType < 0.33) {
        // rain
        ...
        // lava//-->>Created This New lava Effect 
        skyParticles = new ParticleEmitter(
          vec2(), 5, 0, 0, .3, // pos, emitSize, emitTime, emitRate, emiteCone
          0, undefined, // tileIndex, tileSize
          new Color(1, 0.3, 0, 1), new Color(1, 0.6, 0, 0.8), // colorStartA, colorStartB
          new Color(1, 0, 0, 1), new Color(1, 0.3, 0, 0.6), // colorEndA, colorEndB
          2, 0.2, 0.1, 0.5, 0.05, // particleTime, sizeStart, sizeEnd, particleSpeed, particleAngleSpeed
          0.95, 1, 0.8, PI / 2, 0.1, // damping, angleDamping, gravityScale, particleCone, fadeRate,
          0.7, 1 // randomness, collide, additive, randomColorLinear, renderOrder
        );
      }
